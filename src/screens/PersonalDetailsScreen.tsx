...
import { EditPictureSheet } from '@/components/EditPictureSheet';
      ...
      {showSkeleton ? (
        ...
        <ScrollView
          ...
          <View className="mx-4">
            ...
            <View className="gap-3">
              <Pressable onPress={() => push('/personal-details/edit-name' as Href)} className="active:opacity-80">
                <FieldCard label="Name" value={displayOrDash(data?.profile?.displayName)} />
              </Pressable>
              <Pressable onPress={() => push('/personal-details/edit-email' as Href)} className="active:opacity-80">
                <FieldCard label="Email" value={displayOrDash(data?.email)} />
              </Pressable>
              <Pressable onPress={() => push('/personal-details/edit-phone' as Href)} className="active:opacity-80">
                <FieldCard label="Phone" value={displayOrDash(data?.phone)} />
              </Pressable>
              <Pressable onPress={() => push('/personal-details/edit-address' as Href)} className="active:opacity-80">
